...
public class AddressBook {
    ...
    /**
     * Using a Hashmap to store a person's details instead of a string array,
    ...
    private static Set<String> extractKeywordsFromFindPersonArgs(String findPersonCommandArgs) {
        return new HashSet<>(splitByWhitespace(toUpperCase(findPersonCommandArgs.trim())));
        //changed the string to uppercase for case insensitive find command
    }
    ...
    private static ArrayList<HashMap<String, String>> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        ...
        for (HashMap<String, String> person : getAllPersonsInAddressBook()) {
            final Set<String> wordsInName = new HashSet<>(splitByWhitespace(toUpperCase(getNameFromPerson(person))));
            //changed the strings in wordsInName to be uppercase for case insensitivity.
    ...
    */
    ...
    /**
     * Shows a single string of message to the user
     */
    private static void showToUser(String message) {
     ...
     *
     * @param toChange source string
     * @return uppercase of toChange
     */
    private static String toUpperCase(String toChange) {
